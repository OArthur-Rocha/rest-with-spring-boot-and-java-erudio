...
import com.example.restwithspringbootandjavaerudio.serialization.converter.YamlJackon2HttpMessageConverter;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
        converters.add(new YamlJackon2HttpMessageConverter());
    }
